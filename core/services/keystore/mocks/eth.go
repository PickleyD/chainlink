...
// Disable provides a mock function with given fields: key, chainID
func (_m *Eth) Disable(key ethkey.KeyV2, chainID *big.Int) error {
...
// Enable provides a mock function with given fields: key, chainID, qopts
func (_m *Eth) Enable(key ethkey.KeyV2, chainID *big.Int, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, key, chainID)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 error
	if rf, ok := ret.Get(0).(func(ethkey.KeyV2, *big.Int, ...pg.QOpt) error); ok {
		r0 = rf(key, chainID, qopts...)
	} else {
		r0 = ret.Error(0)
	}
...
// Reset provides a mock function with given fields: key, chainID, nonce
func (_m *Eth) Reset(key ethkey.KeyV2, chainID *big.Int, nonce int64) error {
	ret := _m.Called(key, chainID, nonce)

	var r0 error
	if rf, ok := ret.Get(0).(func(ethkey.KeyV2, *big.Int, int64) error); ok {
		r0 = rf(key, chainID, nonce)
	} else {
		r0 = ret.Error(0)
	}
