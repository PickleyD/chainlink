...
func TestFluxMonitor_PollIfEligible(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			tm.keyStore.On("EnabledKeysForChain", (*big.Int)(nil)).Return([]ethkey.KeyV2{{Address: ethkey.EIP55AddressFromAddress(nodeAddr)}}, nil).Once()
...
func TestFluxMonitor_RoundTimeoutCausesPoll_timesOutAtZero(t *testing.T) {
	...
	tm.keyStore.
		On("EnabledKeysForChain", (*big.Int)(nil)).
...
func TestFluxMonitor_DrumbeatTicker(t *testing.T) {
	...
	tm.keyStore.On("EnabledKeysForChain", (*big.Int)(nil)).Return([]ethkey.KeyV2{{Address: ethkey.EIP55AddressFromAddress(nodeAddr)}}, nil)
